...
implement one static methods-
   findMinimumTotalMarks method:this method will take array
of Student objects as input parameters.
This method will return Student object having minimum total marks.


The above mentioned static methods should be called from
main methods.

for findMinimumTotalMarks method: The main method
...
student ans=findMinimumTotalMarks(s);
if(ans!=null){
...
public static student findMinimumTotalMarks(student[] s){
